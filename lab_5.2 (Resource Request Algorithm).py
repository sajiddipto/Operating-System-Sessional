...
if __name__ == "__main__":
    ...
    print("\nEnter new resources request of a process: ")
    request = []
    for i in range(resourceNumber):
        rq = int(input())
        request.append(rq)
        
    whichProcess = int(input("Which process will have this request? \n"))
    
    for i in range(whichProcess):
        if(allocated[i] == whichProcess):
